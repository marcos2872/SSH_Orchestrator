...
export const THEMES: TerminalTheme[] = [
    {
        ...
        name: 'Dark Default',
        theme: {
            background: '#000000', foreground: '#f8fafc', cursor: '#0a84ff',
            selectionBackground: '#1c3a5e',
            black: '#1e293b', brightBlack: '#475569',
            red: '#ff453a', brightRed: '#ff6961',
            green: '#32d74b', brightGreen: '#4cd964',
            yellow: '#ffd60a', brightYellow: '#ffe234',
            blue: '#0a84ff', brightBlue: '#409cff',
            magenta: '#bf5af2', brightMagenta: '#da8fff',
            cyan: '#64d2ff', brightCyan: '#96e4ff',
